...
export const startProjectEmailTemplate = (emailData: EmailData): string => {
  const { project_id, project_name, client_name, start_date, name } = emailData;
  return `
      <!DOCTYPE html>
      <html lang="en">
          <head>
              ...
              <div style="background-color: #DD5928; height: 200px; padding-top: 40px; border-radius: 8px 8px 0 0;
                ...
                <div style="background-color: #ffffff;border-radius: 8px;  margin: auto; text-align: center;  margin: 0px 25px;">
                  ...
                  <div style=" padding: 0px 10px;" >
                      ...
                      <p style="font-family: 'work-sans', sans-serif;font-style: normal;font-weight: 400;font-size: 16px;padding: 5px 0 15px;color: #474d66; margin: auto;text-align: start;">
                      We are pleased to announce the official kickoff of <b>${client_name}'s  ${project_name}</b>.
                      </p>
                      <p style="font-family: 'work-sans', sans-serif;font-style: normal;font-weight: 400;font-size: 16px;padding: 5px 0 15px;color: #474d66; margin: auto;text-align: start;">
                      The project is scheduled to commence on <b>${start_date}</b>. Your contributions and support are instrumental to the success of this endeavor. 
                      </p>
                      <p style="font-family: 'work-sans', sans-serif;font-style: normal;font-weight: 400;font-size: 16px;padding: 5px 0 15px;color: #474d66; margin: auto;text-align: start;">
                      We look forward to embarking on this exciting journey together.
                      </p>
                      <p style="font-family: 'work-sans', sans-serif;font-style: normal;font-weight: 400;font-size: 16px;padding: 5px 0 15px;color: #474d66; margin: auto;text-align: start;">
                      Click <a target="_blank" href="https://armsent-test.amalitech-dev.net/project-details/${project_id}" cursor:="" pointer="">here</a> to view project details.
                      </p>
                      <p style="font-family: 'work-sans', sans-serif;font-style: normal;font-weight: 400;font-size: 16px;padding: 5px 0 15px;color: #474d66;margin: auto;text-align: start;">
                          Best regards, 
                          <br>
